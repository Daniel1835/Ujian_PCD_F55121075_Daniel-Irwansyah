...
class ImageEditor:
    def __init__(self, root):
        ...
        self.canvas = tk.Canvas(self.root, width=550, height=500,
                                highlightthickness=2, highlightbackground='black', bd=2)
        self.canvas.place(x=10, y=10)
        self.frame = tk.LabelFrame(
            self.root, text="Menu", width=200, height=500, bd=2, relief='solid')
        self.frame.place(x=570, y=10)

        self.button_1 = tk.Button(
            self.frame, text="Method perbaikan 1", command=self.method_1)
        self.button_1.place(relx=0.5, rely=0.2, anchor='center')

        self.button_2 = tk.Button(
            self.frame, text="Method perbaikan 2", command=self.method_2)
        self.button_2.place(relx=0.5, rely=0.3, anchor='center')

        self.button_3 = tk.Button(self.root, text="F55121075_Daniel Irwansyah_B",
                                  command=self.show_description, bd=2, relief="solid")
        self.button_3.place(x=400, y=520)
        self.button_3.config(highlightbackground="blue",
    ...
    def show_description(self):
        messagebox.showinfo(
            "Description", "UJIAN - Pengolahan Citra - F55121075 Daniel Irwansyah B")
